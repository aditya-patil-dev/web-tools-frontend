...
function useTools(endpoint: string) {
  const { data, isLoading, isError } = useQuery({
    ...
    retry: 1, // only retry once (hide section on failure)
  });
...
function Section({
  ...
  return (
    <section
      ref={ref}
      className={`ts-section ${inView ? "ts-section--in" : ""}`}
    >
      {/* Header */}
...
function ToolCard({
  ...
  return (
    ...
    >
      ...
      <span className="tc__arrow" aria-hidden>
        <ArrowIcon />
      </span>
    </a>
  );
        ...
        <span className="pc__bar-row">
          <span className="pc__bar">
            <span
              ...
              style={{
                width: barWidth,
                animationDelay: `${index * 55 + 300}ms`,
              }}
            />
          </span>
...
function StarIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 18 18" fill="none">
      <path
        d="M9 1.5l2.06 4.18 4.6.67-3.33 3.24.79 4.58L9 11.94l-4.12 2.23.79-4.58L2.34 6.35l4.6-.67L9 1.5z"
        stroke="currentColor"
        strokeWidth="1.6"
...
function UsersIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 18 18" fill="none">
      ...
      <path
        d="M1.5 15.5c0-3.038 2.462-5.5 5.5-5.5s5.5 2.462 5.5 5.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      ...
      />
      <path
        d="M16.5 15.5c0-2.2-1.1-4-2.5-4.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
