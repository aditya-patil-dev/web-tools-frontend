...
import { FiFileText, FiLink, FiCheckCircle, FiKey } from "react-icons/fi";
...
export default function LegalPageForm({ id }: Props) {
    ...
    const [formData, setFormData] = useState<CreateLegalPagePayload>({
        page_key: "",
        slug: "",
        title: "",
        content: "",
    ...
    useEffect(() => {
        ...
        const fetchPage = async () => {
            try {
                ...
                const page: LegalPageData = await legalPagesAdmin.fetchById(id);
    ...
    const validate = () => {
        ...
        if (!formData.page_key.trim()) newErrors.page_key = "Page key required";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        loading.show({
            message: isEditMode ? "Updating page..." : "Creating page...",
        });

        try {
            if (isEditMode && id) {
                await legalPagesAdmin.update(id, formData as UpdateLegalPagePayload);

                toast.success("Page updated");
            } else {
                await legalPagesAdmin.create(formData);
    ...
    return (
        <div className="adminPage">
            <Form onSubmit={handleSubmit}>
                <PageHeader
                    title={isEditMode ? "Edit Legal Page" : "New Legal Page"}
                    subtitle="
...
"
                ...
                <FormSection title="SEO Metadata" defaultOpen>
                    <TextInput
                        label="Meta Title"
