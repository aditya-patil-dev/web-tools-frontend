...
const stepVariants = {
    ...
    visible: { opacity: 1, x: 0, scale: 1, transition: { duration: 0.7, ease: [0.34, 1.56, 0.64, 1] as const } },
};
const stepNumberVariants = {
    hidden: { scale: 0, rotate: -180 },
    visible: { scale: 1, rotate: 0, transition: { type: "spring" as const, stiffness: 200, damping: 12, delay: 0.2 } },
};
                ...
                >
                    {config.steps.map((step, index) => (
                        ...
                        >
                            ...
                            <motion.p
                                initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }} transition={{ delay: 0.4 + index * 0.15 }}
                            >
                                {step.description}
                            </motion.p>
                        </motion.div>
